...
export default function RegisterPage() {
    ...
    return (
        <main className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden px-4 py-10 sm:px-6 lg:px-8">
            <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.16),_transparent_32%),radial-gradient(circle_at_bottom_left,_rgba(168,85,247,0.14),_transparent_30%),linear-gradient(180deg,_rgba(2,6,23,0.04),_transparent)]" />
            <div className="absolute right-[-8%] top-12 -z-10 h-64 w-64 rounded-full bg-info/15 blur-3xl" />

            <Card className="w-full max-w-md border-border/70 bg-card/90 shadow-2xl backdrop-blur-xl">
                <CardHeader className="space-y-2 pb-2">
                    <div className="inline-flex w-fit items-center gap-2 rounded-full border border-info/20 bg-info/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-info">
                        <LockKeyhole className="h-3.5 w-3.5" />
                        Create account
                    </div>
                    <CardTitle className="text-2xl">Register</CardTitle>
                    <CardDescription>Start a secure workspace for resume analysis.</CardDescription>
                </CardHeader>
